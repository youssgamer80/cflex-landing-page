              ...
              <div
                ...
                >
                  ...
                  <div id="main-chart" >
                    ...
                    <span class="text-orange-900  text-4xl font-bold">Statut de la demande</span>
                    </div>
...
<div class="relative overflow-x-auto shadow-md sm:rounded-lg mx-auto">
  ...
  <button type="button" class="text-white bg-gradient-to-r from-green-400  to-green-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-400 dark:focus:ring-green-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 " data-modal-toggle="popup-modal">retour</button>
   </router-link>
   <br>
  ...
  <!-- form demande -->
   <section>
    ...
    <div>
      ...
      >
        <div
          class="grid grid-cols-1 lg:grid-cols-1 gap-6 xl:gap-8 items-center"
        >
            ...
            >
              <div class="flex items-center">
                ...
                <div class="ml-3">
                  ...
                  <p class="mt-2 text-base leading-6 text-orange-500 dark:text-gray-400">
                   <span v-if="demande.statut" class="text-green-700">accepter</span>
                  <span class="text-gray-700" v-else >en attente</span>
                  </p>
                </div>
              </div>
...
// import StatusDemande from './StatusDemande.vue';
