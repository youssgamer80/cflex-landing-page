                ...
                <div class="
                  ...
                  <div id="main-chart">
                    <div id="apexchartsxsrv0ha6" class="
                      ...
                      <div
                        class="p-4 mb-4 text-sm text-green-700 bg-red-100 rounded-lg dark:bg-red-200 dark:text-green-800"
                        role="alert" v-if="statutAn">
                        <span class="font-medium">Demande Annulée !!!</span> avec succes !!!
                      </div>
                      <div class="p-4 mb-4 text-sm text-red-700 bg-red-100 rounded-lg dark:bg-red-200 dark:text-red-800"
                        role="alert" v-if="statutech">
...
//  this.$toast.success("demande modifiée avec succes ");
  ...
  text: "Êtes-vous sûr de vouloir annuler votre demande ?",
  icon: 'warning',
