    ...
    <body class="bg-gray-50 dark:bg-gray-600">
     ...
     <header class="dark:bg-gray-900 bg-slate-200 sm:flex sm:justify-between sm:items-center sm:py-3">
        ...
        <div :class="isOpen ? 'block' : 'hidden'" class="px-2 pt-2 pb-2 sm:flex" >
          <router-link to="" class="mt-1 block px-3 py-2 rounded-md text-base font-semibold text-slate-500 focus:outline-none focus:text-white focus:bg-gray-700">profile</router-link>
          <!-- <a href="#" class="mt-1 block px-3 py-2 rounded-md text-base font-semibold text-gray-300 hover:text-white hover:bg-gray-700 focus:outline-none focus:text-white focus:bg-gray-700">Team</a> -->
          <router-link to="" class="mt-1 block px-3 py-2 rounded-md text-base font-semibold text-slate-500 hover:text-white hover:bg-gray-700 focus:outline-none focus:text-white focus:bg-gray-700">Projects</router-link>

          <router-link to="" class="mt-1 block px-3 py-2 rounded-md text-base font-semibold text-slate-500 hover:text-white hover:bg-gray-700 focus:outline-none focus:text-white focus:bg-gray-700">Deconnexion</router-link>
              ...
              <div
                ...
                >
                  ...
                  <div id="main-chart" >
                    ...
                    <h1 class="text-orange-900  text-4xl font-bold"><br>formulaire de demande<br></h1>
                    </div>
...
import FormDemproprietaire from '@/components/FormDemproprietaire.vue'
