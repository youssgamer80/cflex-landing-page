            ...
            <div class="mb-5 lg:mb-0">
              <h1
                class="
                  ...
                  font-bold
                  text-gray-900
                  lg:font-extrabold lg:text-7xl lg:leading-tight
                  dark:text-white
                  lg:text-center
                  2xl:px-30
                  lg:mb-8
...
Déplacer vous  avec Flexibilité </h1> -->
      ...
      >
        <div class="max-w-screen-xl px-4 lg:px-12 mx-auto">
          ...
          >
            <div class="mb-5 lg:mb-0">
              <h1
                class="
                  ...
                  font-bold
                  text-gray-900
                  lg:font-extrabold lg:text-2xl lg:leading-tight
                  dark:text-white
                  lg:text-center
                  2xl:px-30
                  lg:mb-8
            ...
            <div class="">
              <img
                class="w-full h-98 p-10 dark:hidden"
      ...
      <section class="max-w-screen-xl px-4 lg:px-12 mx-auto" id="figma">
        <div class="mb-5 lg:mb-0">
          <h1
            class="
              mb-4
        ...
        <div class="">
          <img
            class="p-10 dark:hidden"
            src="assets/User_paging.png"
            alt="Data app"
          />
          <img
            class="w-full h-full hidden dark:block"
