<template>
    <section class="py-24 bg-white dark:bg-gray-900" id="pro">
        <div class="mx-auto max-w-8xl lg:px-4">
            <div class="grid items-center grid-cols-1 gap-6 lg:grid-cols-2 xl:gap-8">
                <div class="relative w-full h-full dark:hidden">
                    <span
                        style="box-sizing: border-box; display: block; overflow: hidden; width: initial; height: initial; background: none; opacity: 1; border: 0px; margin: 0px; padding: 0px; position: absolute; inset: 0px;">
                        <svg style="position: absolute; inset: 0px; box-sizing: border-box; padding: 0px; border: none; margin: auto; display: block; width: 0px; height: 0px; min-width: 100%; max-width: 100%; min-height: 100%; max-height: 100%; object-fit: contain;"
                            sizes="100vw" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" width="839.79697"
                            height="523.44409" viewBox="0 0 839.79697 523.44409"
                            ...
                            <path
                                ...
                                transform="translate(-180.10152 -188.27796)" fill="#ccc" />
                            <circle cx="788.36325" cy="250.94409" r="14" fill="#fe5f00" />
                            <path
                            ...
                            <path
                                ...
                                transform="translate(-180.10152 -188.27796)" fill="#ccc" />
                            <circle cx="660.86325" cy="173.44409" r="14" fill="#fe5f00" />
                            <path
                            ...
                            <path
                                ...
                                transform="translate(-180.10152 -188.27796)" fill="#e4e4e4" />
                            <path id="a80a6b0c-a21b-4eb6-b764-70793a425e46-59" data-name="Path 40"
                                d="M344.36137,305.08309h0a26.60911,26.60911,0,1,1,48.69886-21.4616l.15213.352a26.61391,26.61391,0,1,1-48.86107,21.11392Z"
                                transform="translate(-180.10152 -188.27796)" fill="#ffb6b6" />
                            <path id="b51b91e7-03ed-46d5-9b2a-c48431fd2f0d-60" data-name="Path 72"
                            ...
                            <path
                                ...
                                transform="translate(-180.10152 -188.27796)" fill="#fe5f00" />
                            <path
                            ...
                            <path
                                ...
                                transform="translate(-180.10152 -188.27796)" fill="#ccc" />
                            <circle cx="530.86325" cy="94.44409" r="14" fill="#fe5f00" />
                            <path
                            ...
                            <path d="M562.10152,711.722h-381a1,1,0,0,1,0-2h381a1,1,0,0,1,0,2Z"
                                transform="translate(-180.10152 -188.27796)" fill="#cacaca" />
                        </svg>
                        <noscript></noscript>
                    </span>
                </div>
                <div class="relative hidden w-full h-full dark:block">
                                        ...
                                        <form class="space-y-4 md:space-y-6" action="#">
                                            <div class="grid md:grid-cols-2 md:gap-6">
                                                <div class="relative z-0 mb-6 w-full group">
                                                    <div>
                                                        <label for="email"
                                                            class="block mb-2 text-sm font-medium hidden text-gray-900 dark:text-white">Your
                                                            email</label>
                                            ...
                                            <div>
                                                <label for="password"
                                                    class="block mb-2 text-sm font-medium hidden text-gray-900 dark:text-white">Password</label>
                                            ...
                                            <div>
                                                <label for="confirm-password"
                                                    class="block mb-2 text-sm font-medium hidden text-gray-900 dark:text-white">Confirm
                                                    password</label>
                                            ...
                                            <div class="flex items-start">
                                                ...
                                                <div class="ml-3 text-sm">
                                                    <label for="terms"
                                                        class="font-light text-gray-500 dark:text-gray-300">I accept the
