      ...
      <nav class="fixed z-30 w-full bg-gray-50">
       ...
       <header class="dark:bg-gray-900 bg-slate-200 sm:flex sm:justify-between sm:items-center sm:py-3">
        ...
        <div :class="isOpen ? 'block' : 'hidden'" class="px-2 pt-2 pb-2 sm:flex" >
          <router-link to="" class="mt-1 block px-3 py-2 rounded-md text-base font-semibold text-slate-500 hover:text-white hover:bg-gray-700 focus:outline-none focus:text-white focus:bg-gray-700">profile</router-link>
                                  ...
                                  >
                                    ...
                                    <select
                                      ...
                                      class="
                                        ...
                                        sm:text-sm
                                      "
                                      v-model="demande.idTypeTransportFk"
                                    >
                                      <option
...
//     try {
//      let reponse =  DemandeService.getAllDemandeByID(this.idemande);
//      this.demande = reponse.data.data;
...
// }
  ...
  try{
    ...
    let reponse = DemandeService.updateDemande(this.demande,this.idemande);
 ...
 mounted() {
    ...
    //   axios
    //     .put(`api/demandes/updateDemande/${this.idemande}`, {
    //       idProprietaireFk: {
    //         id: 1,
    //       },
