        ...
        <nav className="flex justify-between items-center px-3 mx-auto w-full max-w-8xl lg:px-4">
            <div className="container flex flex-wrap justify-between items-center mx-auto">
                ...
                <div className="flex md:order-2">
                    ...
                    <button className="text-white bg-cflex-200 hover:bg-cflex-100
                ...
                <div className="hidden justify-between items-center w-full md:flex md:w-auto md:order-1" id="mobile-menu-4">
                    <ul className="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
                        {navLinks.map((nav, index) => (
                            <li>
                                <a href={nav.id} class="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-cflex-100 md:hover:bg-transparent md:border-0 md:hover:text-cflex-100 md:p-0 md:dark:hover:text-white dark:text-gray-400 dark:hover:bg-cflex-100 dark:hover:text-cflex-100 md:dark:hover:bg-transparent dark:border-gray-700 font-poppins">
                                    {nav.title}
                                </a>
                            </li>
                        ))}
