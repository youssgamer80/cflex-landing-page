...
<template>
    <div class="relative overflow-hidden bg-white">
          ...
          <main class="mx-auto mt-10 max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            ...
            <div class="sm:text-center lg:text-left">
              ...
              <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl md:text-6xl">
                <span class="block xl:inline">Site en maintenance</span>
                {{ ' ' }}
                <span class="block text-primary-900 xl:inline">Bientôt disponible
                  <div>
                    <router-link to="/">
                      <img src="../assets/logo.png" class="logo" alt="Vite logo" />
                    </router-link>            
                  </div>
                </span>
              </h1>
             
              <p class="mt-3 text-base text-gray-500 sm:mx-auto sm:mt-5 sm:max-w-xl sm:text-lg md:mt-5 md:text-xl lg:mx-0">Nos administrateurs système effectuent des travaux de maintenance programmés.</p>
              <div class="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                ...
                <div class="mt-3 sm:mt-0 sm:ml-3">
                  <a href="#" class="flex w-full items-center justify-center rounded-md border border-transparent bg-indigo-100 px-8 py-3 text-base font-medium text-primary-700 hover:bg-indigo-200 md:py-4 md:px-10 md:text-lg">Merci et à très vite.</a>
                </div>
              </div>
            </div>
          </main>
      ...
      <div class="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
        <img class="h-56 w-full object-cover sm:h-72 md:h-96 lg:h-full lg:w-full" src="https://images.unsplash.com/photo-1531482615713-2afd69097998?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2070&q=80" alt="" />
      </div>
    </div>
  </template>
  ...
  <script>
    ...
    var countDownDate = new Date("Sep 11, 2022 23:30:00").getTime();
    ...
    var x = setInterval(function() {
      ...
      if (distance < 0) {
        clearInterval(x);
        document.getElementById("counter").innerHTML = "Dans un instant";
      }
    }, 1000);
    </script>
